...
begin
  ...
  puts "wrong error message" unless e.message.eql?("'LEGO Iron Man vs. Ultron' already exists.")
end
...
begin
  ...
  puts "wrong error message" unless e.message.eql?("'Walter Latimer' already exists.")
end
